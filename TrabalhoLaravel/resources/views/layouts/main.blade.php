...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../Assents/Css/index.css">
    ...
    <link rel="stylesheet" href="../../Assents/fontawesome-free-5.15.4-web/css/all.css">
    <script src="../../Assents/fontawesome-free-5.15.4-web/js/all.js"></script>
    <title>System</title>
</head>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" style="gap: 10px">
                ...
                <li class="nav-item">
                    <button class="nav-link" onclick="if (confirm('Do you really want exit ?')) { logout() }">
